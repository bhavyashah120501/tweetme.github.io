...
export function FeedList({newTweets}){
  ...
  return (<div className='row'>
            ...
            {nextUrl != null && <button onClick={handleLoadNext} className='btn btn-md mt-2 btn-outline-primary'>Load Tweets</button>}
          </div>)
}
